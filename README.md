...
| **proxy.srs** | `https://cdn.jsdelivr.net/gh/jinndi/singbox_ruleset@main/proxy.srs` | [geosite-blocked](https://github.com/jinndi/geosite-blocked) | Списки зарубежных доменов, требующих аэропорта из РФ. |
